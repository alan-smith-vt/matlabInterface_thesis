...
import numpy as np
import bisect
from slicePointCloud_raw import slicePointCloudf
...
np.save(saveLoc.saveLoc + "/backups/br.npy",R)
...
start,begining = slicePointCloudf(start,begining,xyz_load,rgb_load,p.ax,p.N)
start,begining = clockMsg("\t\t",start,begining,flag)
